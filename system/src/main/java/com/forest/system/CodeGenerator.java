...
public class CodeGenerator {
     ...
     * 数据库地址
     */
    private final static String dbUrl = "jdbc:mysql://172.16.104.101:3306/ywws_sys?characterEncoding=utf8&useSSL=true&serverTimezone=Asia/Shanghai&nullNamePatternMatchesAll=true";
    /**
     * 数据库驱动
     */
     ...
     * 数据库用户
     */
    private final static String dbUserName = "ywws";
    /**
     * 数据库密码
     */
    private final static String dbPassWord = "GR2023@hz_user";
    /**
     * 作者名
     */
     ...
     * 包名
     */
    private final static String parents = "com.forest";

    /**
     * 输出目录
     */
    private final static String projectPath = System.getProperty("user.dir") + "/keepsoft-system/keepsoft-system-biz/src/main/java";
    /**
     * mapper.xml 输出目录
     */
    private final static String xmlPath = System.getProperty("user.dir") + "/keepsoft-system/keepsoft-system-biz/src/main/resources/mybatis";
    ...
    public static void main(String[] args) {
        ...
        String modelName = parents.substring(parentPath.lastIndexOf("/")+1);
