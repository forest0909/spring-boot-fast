...
public class CodeGenerator {
     ...
     * 数据库地址
     */
    private final static String dbUrl = "jdbc:mysql://1270.0.0.1:3306/sys?characterEncoding=utf8&useSSL=true&serverTimezone=Asia/Shanghai&nullNamePatternMatchesAll=true";
    /**
     * 数据库驱动
     */
     ...
     * 包名
     */
    private final static String parents = "com.forest.system";

    /**
     * 输出目录
     */
    private final static String projectPath = System.getProperty("user.dir") + "/system/src/main/java";
    /**
     * mapper.xml 输出目录
     */
    private final static String xmlPath = System.getProperty("user.dir") + "/system/src/main/resources/mybatis";
